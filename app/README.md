...
v0.03 attempts the exact known GitHub source first:
...
The full face-screen palette assignment for indices 5–13 has not yet been traced. v0.03 therefore shows those entries using neutral reference greys. Renderer conventions for indices 14 and 15 are shown as dark blue and grey. Do not treat the resulting hybrid display as final colour-authentic output.
...
This means fixed-size pixel edits can ultimately be patched directly into the executable at the original payload offset. Resizing or relocating components is a separate problem and is deliberately not part of v0.03.
